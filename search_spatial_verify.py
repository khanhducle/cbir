...
from cbir.ir import SpatialVerifier
...
cv2.imwrite("output/results/tfidf_ransac/query_{}".format(name), imutils.resize(queryImage, width=320))
...
cv2.imwrite("output/results/tfidf_ransac/results_{}".format(name), imutils.resize(montage.montage, height=700))
